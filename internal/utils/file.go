...
func QrCode(url, filePath string) (filename string, err error) {
...
func GetUploadFilePath(filePath, fielname string) (savePath string, err error) {
	return path.Join(filePath, fielname), nil
}
